...
const packages = [
  {
    ...
    optimisation: "light",
    support: "standard",
    description: "Basic is for companies that want to take the first serious step toward predictable lead generation.",
  },
  {
    name: "Growth",
    price: "€750 per month",
    ...
    support: "standard",
    description: "Growth is for companies that do not want the occasional inquiry, but want to build a more consistent flow.",
  },
  {
    name: "Scale",
    ...
    optimisation: "weekly",
    support: "priority",
    description: "Scale is for companies that want faster growth across multiple services, regions or markets and need a stronger system for that.",
  },
];
      ...
      <section className="accent-grid panel relative overflow-hidden rounded-[40px] px-6 py-12 md:px-10 md:py-16">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            body="We work with fixed packages. No surprises. No marketing fluff. Just a clear approach focused on generating more inquiries."
          />
        ...
        <div className="overflow-hidden rounded-[36px] border border-[var(--border)] bg-white shadow-[0_28px_70px_rgba(17,17,17,0.08)]">
          ...
          <div className="hidden grid-cols-4 border-b border-[var(--border)] bg-[var(--dark)] text-white md:grid">
            ...
            {packages.map((item) => (
              <div
                key={item.name}
                className={clsx("px-4 py-5 md:px-6", item.name === "Growth" && "bg-white text-[var(--foreground)]")}
              >
                {item.badge ? (
